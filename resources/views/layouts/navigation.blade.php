  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-16">
      ...
      <div class="hidden sm:flex sm:items-center sm:ms-6">
        ...
        <button @click="toggleTheme" class="p-2 rounded transition-colors duration-300 bg-gray-200 dark:bg-gray-700" aria-label="Cambiar tema">
          ...
          <svg x-show="!darkMode" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
