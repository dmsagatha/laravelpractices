<nav x-data="{ open: false }" class="border-b border-gray-100 bg-slate-50 dark:border-gray-700 dark:bg-gray-800">
    ...
    <div class="flex h-16 justify-between">
      <div class="flex">
        ...
        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
          ...
          <x-nav-link :href="route('users.indexsendMessage')" :active="request()->routeIs('users.indexsendMessage')">
            {{ __('Mass emails') }}
          </x-nav-link>
        </div>
      </div>
  ...
  <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
    <div class="space-y-1 pt-2 pb-3">
      ...
      <x-responsive-nav-link :href="route('users.indexsendMessage')" :active="request()->routeIs('users.indexsendMessage')">
        {{ __('Mass emails') }}
      </x-responsive-nav-link>
    </div>
